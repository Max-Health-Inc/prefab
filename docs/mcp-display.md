...
```ts
import { display, Column, H1, autoTable } from '@max-health-inc/prefab'
...
```ts
import { display_form } from '@max-health-inc/prefab/mcp'
...
```ts
import { display_update } from '@max-health-inc/prefab/mcp'
...
```ts
import { display_error } from '@max-health-inc/prefab/mcp'
