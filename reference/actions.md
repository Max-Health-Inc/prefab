---
url: /prefab/reference/actions.md
description: >-
  API reference for prefab actions — CallTool, SetState, ShowToast, Navigate,
  OpenLink, Validate, and all serializable event handlers.
---
