---
url: /prefab/reference/mcp-display.md
description: >-
  API reference for display(), displayForm(), rendererHtml(),
  registerViewerResource(), PREFAB_RESOURCE_URI, and MCP display helper types.
---
