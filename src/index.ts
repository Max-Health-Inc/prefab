...
export { fieldsFromJsonSchema } from './auto/schema.js'
...
export type { AutoFormField, AutoFormOption, AutoFormOptions } from './auto/form.js'
export type { FieldsFromJsonSchemaOptions, JsonSchemaNode } from './auto/schema.js'
...
export type { McpToolResult, McpDisplayResult, McpContent, McpTextContent, McpImageContent, McpResourceContent, McpTextResourceContents, McpBlobResourceContents, McpCacheScope, McpCacheHint, McpResourceReadResult } from './mcp/types.js'
export { formSchema, formInputRequest, acceptedFormInput, inputResponse } from './mcp/input-required.js'
export type { FormInputRequestOptions, FormValue } from './mcp/input-required.js'
export type { McpPrimitiveSchema, McpRestrictedSchema, McpElicitRequest, McpElicitResult, McpInputRequests, McpInputResponses, McpInputRequiredResult } from './mcp/types.js'

// ── A2UI ─────────────────────────────────────────────────────────────────────
export { emitA2UI, mappedTypes, A2UI_VERSION, A2UI_BASIC_CATALOG, A2UI_MIME, A2UI_SCHEME } from './a2ui/index.js'
export type { A2uiEmitOptions, A2uiEmitResult, A2uiMessage, A2uiMessageList, A2uiComponent, A2uiDiagnostic, A2uiDiagnosticKind } from './a2ui/index.js'
export { display_a2ui, displayA2ui, registerA2uiResource, a2uiPayload, A2UI_RESOURCE_URI } from './mcp/a2ui.js'
export type { DisplayA2uiOptions, A2uiResourceOptions } from './mcp/a2ui.js'
